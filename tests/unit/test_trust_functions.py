...
from connectonion.trust_functions import (
    check_whitelist,
...
class TestCheckWhitelist:
    ...
    def test_exact_match_on_whitelist(self, tmp_path):
        ...
        with patch('connectonion.trust_functions.Path.home', return_value=tmp_path.parent):
    ...
    def test_not_on_whitelist(self, tmp_path):
        ...
        with patch('connectonion.trust_functions.Path.home', return_value=tmp_path):
...
class TestGetTrustVerificationTools:
    ...
    def test_contains_test_capability(self):
        ...
        from connectonion.trust_functions import test_capability
