...
Run with: pytest tests/real_api/test_llm_do.py -v
...
# Import skip markers from conftest (available automatically via pytest)
# has_openai_key, has_anthropic_key, has_gemini_key
...
class TestCrossProviderConsistency:
    ...
    def test_all_providers_basic_math(self):
