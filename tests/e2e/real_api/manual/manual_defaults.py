...
# Expected values
expected_agent = "co/gemini-3.8-flash"
expected_llm_do = "co/gemini-3.8-flash"
...
print("   ")
print("   # Simple call - uses co/gemini-3.8-flash")
print("   answer = llm_do('What is 2+2?')")
print("   ")
print("   # Agent - uses co/gemini-3.8-flash")
...
print("   - co/gemini-3.8-flash ✓")
print("   - co/gemini-3.7-flash ✓ (explicit rollback)")
