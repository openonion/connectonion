...
- `browser` PRs #104–#105 advance the paid target to Chromium 151.0.7922.137 and
  ...
  project-owned macOS E2E command did not exist. Head `4fb76ab` now makes the WebGL
  ...
  `--publish-prepared` validates those same bytes before any cloud call and repeats the
  runtime gates before upload and after redownload without rebuilding. All 51 tests plus
  31 patch subtests pass. The exact six-patch source and manifest verify
