...
- `onionwright` PRs #41–#43 implement typed preflight/acquisition, renewable session
  ...
  paid-lifecycle review is recorded and all 263 tests pass in the combined oo-api
  dependency environment. Head `6a60ed6` now preserves the exact reviewed wheel between
  credential-free preparation and upload, refuses dirty source, and binds evidence to
  source commit/tree; the verified 0.0.11 wheel is 51,165 bytes with
