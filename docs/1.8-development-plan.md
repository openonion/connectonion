...
- `connectonion` draft PR #1280 is now stacked on the final async Browser Core/facade
  ...
  lifecycle, and CLI propagation. A dedicated CI job checks out Onionwright #43 and
  runs the real async paid-launch boundary across both source trees. It remains Draft
