...
- `browser` PRs #104–#105 advance the paid target to Chromium 151.0.7922.137 and
  ...
  project-owned macOS E2E command did not exist. Head `8ae50b4` now makes the WebGL
  ...
  native proxy auth, and adds credential-free unsigned bundle provenance preflight.
  All 44 tests plus 31 patch subtests pass. The exact six-patch source and manifest verify
