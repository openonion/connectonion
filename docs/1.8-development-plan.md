...
- `oo-api` PR #183 implements the signed exact-platform manifest, non-billable
  ...
  pass. Neither catalogue contains a releasable browser artifact yet.
- `onionwright` PRs #41–#43 implement typed preflight/acquisition, renewable session
  ...
  current source commit/tree; the newly authoritative 0.0.11 wheel is 51,189 bytes with
  SHA-256 `a0f9f9aa2a58779ab7eba68b3f8b6c0915ed5509978168011bb592878e378957`.
  It has not been uploaded because gcloud has no active account and private hosted jobs
  are blocked before checkout.
