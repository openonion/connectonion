...
- `browser` PRs #104–#105 advance the paid target to Chromium 151.0.7922.137 and
  ...
  compile found and fixed two Chromium 151 auth API drifts. Full application linking,
  native behavioral coverage, and certified Mac/Linux artifacts remain unproven while
  hosted builders are blocked.
