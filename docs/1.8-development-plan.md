...
- `onionwright` PRs #41–#43 implement typed preflight/acquisition, renewable session
  ...
  dependency environment. Head `d62355f` now preserves the exact reviewed wheel between
  credential-free preparation and upload; the verified 0.0.11 wheel is 51,165 bytes with
