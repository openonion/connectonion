...
- `connectonion` draft PR #1280 is now stacked on the final async Browser Core/facade
  ...
  honestly run in ConnectOnion-hosted CI without a separately scoped credential. It remains Draft
  until Onionwright 0.0.11 and at least one certified browser artifact exist.
