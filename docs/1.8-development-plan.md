...
- `oo-api` PR #183 implements the signed exact-platform manifest, non-billable
  ...
  recorded; 54 focused tests and the 671-test local suite pass with 154 expected skips.
  ...
  formats—before a catalogue can be signed or used for billing.
  ...
  the same canonical catalogue gate, and 680 local tests pass. Neither catalogue
