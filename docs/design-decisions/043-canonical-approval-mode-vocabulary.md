# DD-043: Approval modes use mainstream product vocabulary

**Status:** Accepted

**Date:** 2026-08-12

**Related:** [019 Client Approval Modes](019-client-approval-modes.md), [031 ACP Permission Modes](031-acp-permission-modes.md), [039 Host ACP Session Modes](039-host-acp-session-modes.md), [Issue #903](https://github.com/openonion/connectonion/issues/903)
...
and differed across the Host, React SDK, O Chat, ACP, documentation, and
...
Host and SDK serializers emit only canonical values. Compatibility readers may
