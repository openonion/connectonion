...
class SourceInventory:
    ...
    def window(self, provider: str, start: str, end: str, count: int | None, limit: int) -> None:
        if count is None:
    ...
    def save(self, report: dict) -> dict:
        ...
        return {"summary": str(summary.relative_to(self.root)),
                ...
                "capped_mail_windows": capped, "mailbox_total": "unknown"}
