...
LLM-Note:
  ...
  Performance: network call to backend (2-5s) | signature generation is fast (<10ms) | file I/O for .env and host.yaml | retries on network errors (up to 3 attempts with exponential backoff)
