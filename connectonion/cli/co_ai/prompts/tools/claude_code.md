...
The current co ai mode determines Claude Code's mode. Default uses Claude's
normal permission rules. Auto-approve permits in-scope
file edits while retaining Claude's rules for other actions. Full access (YOLO)
