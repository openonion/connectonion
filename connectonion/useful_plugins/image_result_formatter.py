...
def _format_image_result(agent: 'Agent') -> None:
    ...
    # Keep tool message with shortened text + insert assistant message with image
    # This makes semantic sense: the image is generated by the agent's tool (assistant's action)
    # Modern OpenAI models support images in assistant messages
