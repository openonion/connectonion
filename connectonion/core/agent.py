...
class Agent:
    ...
    def __init__(
        ...
        # Images generated by image-output models (data URLs, from most recent LLM call)
    ...
    def _get_llm_decision(self):
        ...
        # Capture generated images (image-output models like gemini-2.5-flash-image)
        if response.images:
            self.last_images = response.images
            if self.io:
                for image_url in response.images:
                    self.io.send_image(image_url)
