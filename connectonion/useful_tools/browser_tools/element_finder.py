...
LLM-Note:
  Dependencies: imports from [playwright.sync_api Page, connectonion llm_do, pydantic, pathlib] | imported by [cli/browser_agent/browser.py] | tested by [tests/e2e/cli/test_element_finder.py]
...
def find_element(
    ...
    if 0 <= result.index < len(elements):
        ...
        print(f"  Locator: {selected.locator}")
