...
LLM-Note:
  ...
  Integration: WTFbrowser owns native browser/network protection; this module shapes the interaction layer above it (curved cursor paths, human velocity, log-normal keystroke cadence, wheel events, and trusted CJK paste/IME fallback). No public tool signatures change.
